      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-xs text-dim">
            Where every vessel is, what she is doing, and anything that needs a look.
          </p>
        </div>
        <Link href="/vessels" className="text-xs text-brass hover:underline">
          Vessel register and particulars
        </Link>
      </div>
