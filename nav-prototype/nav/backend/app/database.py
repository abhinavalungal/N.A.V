...
# tables, never missing columns, so an existing database needs them adding.
# This is a prototype convenience, not a migration tool - anything beyond
# adding a nullable column needs Alembic.
