...
Runs against the async engine defined by DATABASE_URL. Model metadata is
imported from app.models so that `alembic revision --autogenerate` sees every
table as the schema grows.
"""
